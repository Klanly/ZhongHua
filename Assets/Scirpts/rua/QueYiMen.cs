...
public class QueYiMen : MonoBehaviour
{
    #region UP
    ...
    public static QueYiMen instance;
    ...
    {
        LoginInfo.Instance().mylogindata.ALLScroce = (int.Parse(LoginInfo.Instance().mylogindata.ALLScroce) - num).ToString();
        GoldText.text = LoginInfo.Instance().mylogindata.ALLScroce;
    }
    ...
    void OnAddPoker(int color, int num)
    {
        ...
        if (color == 3)
        {
            ...
            {
                wordGo.transform.GetChild(resultCount).GetComponent<Image>().sprite = wordSprite[3];
                wordGo.transform.GetChild(resultCount).gameObject.SetActive(true);
                picGo.transform.GetChild(resultCount).GetComponent<Image>().sprite = picSprite[3];
                picGo.transform.GetChild(resultCount).gameObject.SetActive(true);
            }
        }
        else
